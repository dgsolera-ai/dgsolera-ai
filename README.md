...
**[vae-wae-generative-models](https://github.com/dgsolera-ai/vae-wae-generative-models)** — Generative models from scratch: VAE (KL) vs Wasserstein Autoencoder (MMD), compared across 2D images and 3D voxel grids (MNIST, CIFAR-10, ModelNet10). Focused on where each latent regularizer breaks, not just where it works.
---
